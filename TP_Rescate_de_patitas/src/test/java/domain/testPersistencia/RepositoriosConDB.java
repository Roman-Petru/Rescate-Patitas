...
public class RepositoriosConDB {
    ...
    public void testInsertPersona() {
        ...
        DatosDePersona datosDePersona = new DatosDePersona("Chicle", "Pavo", "489", "53535", "asddfsdf@hotmail.com", ubicacion, null);
...
/*        Ubicacion ubicacion = new Ubicacion();
        ...
        //DatosDePersona datosDePersona = new DatosDePersona("Ramita", "Gonzalez", "3535", "53535", "asddfsdf@hotmail.com", null, null);
        DatosDePersona datosDePersona = PersonaController.getInstancia().buscarPersonaporDNI("489");
        datosDePersona.setNombre("Ramita");
        DatosDePersona.DatosDePersonaDTO dto = datosDePersona.toDTO();



        //TODO crea ubicacion nuevamente
        PersonaController.getInstancia().modificar(dto.getId(), dto);
